...
define('API_BASE_URL', 'https://ppv.to/api/streams');
define('FILE_EXTENSION', '-ppv.land.m3u');

// Fixed user-agent to be used across the script
define('USER_AGENT', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:109.0) Gecko/20100101 Firefox/115.0');
...
function createM3UEntry($data, $category) {
    ...
    $extVlcOptReferrerLine = '#EXTVLCOPT:http-referrer=https://ppv.to/' . "\n";
    $extVlcOptOriginLine = '#EXTVLCOPT:http-origin=https://ppv.to/' . "\n";
